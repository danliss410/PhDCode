function createOSIMInputFilesVICON_NeuroMobLab_DJL(forceRepresentation, markerFile, grfFile, fileLocation, filename, subjectName)
%
...
folderLoc = ['G:\Shared drives\NeuroMobLab\Projects\Perception\Processed Data\Dan\OpenSim\YAPercep Outputs\YAPercep' subjectName '\MarkerAndGRFDataFiles\'];
...
%     c3d.writeTRC([new_path_name filename '_XTRAPELV_markers_rotated.trc'],newMarkerTable);
    c3d.writeTRC([folderLoc filename '_markers_rotated.trc'],newMarkerTable);
